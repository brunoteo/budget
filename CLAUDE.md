...
- **Pure libraries** under `lib/{auth,category,cycle,kpi,format,forecast,trends,import}` import nothing from `next`, `react`, or `@supabase/*`. They are unit-tested in isolation.
